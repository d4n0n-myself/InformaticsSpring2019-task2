...
export class HttpService {
  ...
  getComments() : Observable<PostComment[]> {
    return this.http.get<PostComment[]>(`${this.baseUrl}Comment/GetAll`, this.httpOptions);
  }

  getCommentsForPost(post : string) : Observable<PostComment[]> {
    return this.http.get<PostComment[]>(`${this.baseUrl}Comment/GetByPost?post=${post}`, this.httpOptions);
  }
